...
//生成token
func GenerateToken(user string, userId string, JwtSecret string) (string, error) {
...
//验证token是否有效
func VerifyToken(m map[string]string, tokenString string, JwtSecret string) (bool, error) {
